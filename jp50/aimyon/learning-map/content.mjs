...
songs.push({"id":"sora-no-aosa","title":"空の青さを知る人よ","color":"#295e86","lead":"曾經不喜歡的事，如今成為尋找對方的線索。","path":"sora-no-aosa"},{"id":"konya-konomama","title":"今夜このまま","color":"#814c39","lead":"說不出口的心意，在夜裡尋找暫停的地方。","path":"konya-konomama"},{"id":"futaba","title":"双葉","color":"#3f704b","lead":"在成長與告別之間，把祝福留給未來的你。","path":"futaba"},{"id":"aini-ikunoni","title":"会いに行くのに","color":"#755789","lead":"冰箱、紅盒與冬天，反覆回想未能交付的愛。","path":"aini-ikunoni"},{"id":"yakou-bus","title":"夜行バス","color":"#806338","lead":"漫長車程裡，帶著害怕仍然追夢。","path":"yakou-bus"},{"id":"sakura-ga-furu-yoru-wa","title":"桜が降る夜は","color":"#92516e","lead":"花落的夜裡，想見你，卻仍在想該不該說。","path":"sakura-ga-furu-yoru-wa"});
